...
[*R4DS* Chapter 5, Section 2: Tidy data](https://r4ds.hadley.nz/data-tidy.html#sec-tidy-data)
:::
...
::: {.callout-required-reading}
[*R4DS* Chapter 5, Section 3: Lengthening data](https://r4ds.hadley.nz/data-tidy.html#sec-pivoting)
:::
...
::: {.callout-required-reading}
[*R4DS* Chapter 5, Section 3: Widening data](https://r4ds.hadley.nz/data-tidy.html#widening-data)
:::
...
::: {.callout-required-reading}
[*R4DS* Chapter 19: Joins](https://r4ds.hadley.nz/joins.html)
:::
...
::: {.callout-tip}
You can think of this as a relative of the `filter_out()` function, which is 
a better tool for negating a filter statement (e.g.,
`filter(! day %in% c("Mon", "Tues", "Wed"))`).
:::
