...
1. Which statement best describes the difference between an absolute file path
...
[*R4DS* Chapter 8: Workflow and Projects](https://r4ds.had.co.nz/workflow-projects.html)
:::
...
(as instructed in [Part 1 of this week's coursework](setup-workflow.qmd)), you
should already have Quarto installed on your computer. But, let's test it
out.
...
::: {.callout-learn-more}
If you are interested in learning more about formatting options for Quarto HTML
documents, I would recommend checking out:
