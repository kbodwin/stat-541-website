...
[*R4DS* Chapter 1: Data Visualisation](https://r4ds.hadley.nz/data-visualize.html)
:::

<!-- this should be recommended not required-->
...
::: {.callout-required-reading}
[*R for Data Science* Chapter 9 - Layers](https://r4ds.hadley.nz/layers.html)
:::